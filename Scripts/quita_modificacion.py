...
x = Dense(512, activation='swish', kernel_regularizer=tf.keras.regularizers.l2(0.01))(x)
...
for layer in base_model.layers[:50]:  # Congelar las primeras 50 capas
...
model.save('Modelos/Modelos_quita/recycling_classifier_model.h5')

# 11. Convertir el modelo a TensorFlow Lite
converter = tf.lite.TFLiteConverter.from_keras_model(model)
tflite_model = converter.convert()

with open('Modelos/Modelos_quita/recycling_classifier_model.tflite', 'wb') as f:
